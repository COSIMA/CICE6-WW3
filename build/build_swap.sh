...
#
# These scripts assume that everything but the ocn component has already been
# created by CIME.
# 
...
bld_dir=/scratch/tm70/ds0092/cime/scratch/GMOM_JRA_WD2/bld
